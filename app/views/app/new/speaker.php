...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $exists = Functions::Speakers()->check($brand_id, $name);
    if ($exists) {
    ...
    <h3>New Speaker</h3>
    <form name="new_speaker" method="post" action="/app/new/speaker" enctype="multipart/form-data">
        ...
        <div class="new_speaker_form">
                ...
                <div class="form-element-tooltip">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="impedance" name="impedance" oninput="calculateVoltage();">
                            <option>Select Impedance...</option>
            ...
            <div class="form-divider">
                <div style="grid-column:1/2;" class="form-element-tooltip">
                    ...
                    <div class="input-group">
                        <input class="form-input" type="number" id="power_rms" name="power_rms" oninput="calculatePower(); calculateVoltage();" placeholder="RMS/AES Power (W)...">
            ...
            <div class="form-divider">
                <div class="form-element-tooltip">
                    ...
                    <div class="input-group">
                        <input class="form-input" type="number" id="sens_spl" name="sens_spl" oninput="calculateMaxSPL('sens_spl', 'power_rms', 'max_spl')" placeholder="Sensitivity (dB)...">
                ...
                <div class="form-element-tooltip">
                    ...
                    <div class="input-group">
                        <input class="form-input" type="number" id="max_spl" step="0.01" name="max_spl" placeholder="Maximum SPL (dB)...">
                        <span class="input-group-addon addon-sm">dB</span>
                    </div>
                </div>
            </div>
