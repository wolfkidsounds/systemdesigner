        ...
        <div class="new_limiter_form">
            ...
            <div class="form-divider">
                <div style="grid-column:1/2;" class="form-element-tooltip">
                    ...
                    <select class="form-select" id="bridge_mode" name="bridge_mode">
...
$(document).ready(function () {
        ...
        if (areAllOptionsSelected()) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('.lim_vlip_value').text(data.lim_vlip_value);
    ...
    $('#processor, #amplifier, #speaker').change(function () {
        calculateLimiters();
    });
});
