            ...
            <div class="form-divider">
                ...
                <!--
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td class="table-term">Peak Limit</td>
                                <td class="table-value lim_factor_peak"></td>
                                    <td class="table-symbol"></td>
                            </tr>
                            <tr>
                                <td class="table-term">RMS Limit</td>
                                <td class="table-value lim_factor_rms"></td>
                                    <td class="table-symbol"></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="form-divider"></div>
                    <div class="disabled">
                        <h6>Amplifier Usage Potentail (AUP)</h6>
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td class="table-term">Usage</td>
                                    <td class="table-value aup"></td>
                                    <td class="table-symbol">%</td>
                                </tr>
                                <tr>
                                    <td class="table-term">Headroom</td>
                                    <td class="table-value aup_headroom"></td>
                                    <td class="table-symbol">dB</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="form-divider disabled"></div>
                    <div class="disabled">
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td class="table-term">Usage</td>
                                    <td class="table-value lup"></td>
                                    <td class="table-symbol">%</td>
                                </tr>
                                <tr>
                                    <td class="table-term">Headroom</td>
                                    <td class="table-value luü_headroom"></td>
                                    <td class="table-symbol">dB</td>
                                </tr>
                            </tbody>
                        </table>
