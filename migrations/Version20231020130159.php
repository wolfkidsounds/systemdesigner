 ...
 */
final class Version20231020130159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE limiter ADD COLUMN bridge_mode_enabled BOOLEAN NOT NULL DEFAULT FALSE');
