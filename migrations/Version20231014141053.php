 ...
 */
final class Version20231014141053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE amplifier ADD COLUMN validated BOOLEAN NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__amplifier AS SELECT id, user_id, manufacturer_id, name, power16, power8, power4, power2, power_bridge8, power_bridge4 FROM amplifier');
        ...
        $this->addSql('INSERT INTO amplifier (id, user_id, manufacturer_id, name, power16, power8, power4, power2, power_bridge8, power_bridge4) SELECT id, user_id, manufacturer_id, name, power16, power8, power4, power2, power_bridge8, power_bridge4 FROM __temp__amplifier');
