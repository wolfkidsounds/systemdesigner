...
class LimiterController extends AbstractController
{
    ...
    public function index(LimiterRepository $limiterRepository): Response
    {
        ...
        return $this->render('pages/crud/limiter/index.html.twig', [
            'limiters' => $limiters,
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pages/crud/limiter/new.html.twig', [
            'limiter' => $limiter,
            'form' => $form,
            'title' => new TranslatableMessage('Limiter'),
    ...
    {
        return $this->render('pages/crud/limiter/show.html.twig', [
            'limiter' => $limiter,
            'title' => new TranslatableMessage('Limiter'),
    ...
    public function edit(Request $request, Limiter $limiter, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pages/crud/limiter/edit.html.twig', [
            'limiter' => $limiter,
            'form' => $form,
            'title' => new TranslatableMessage('Limiter'),
